...
public class Partida {
    ...
    public static void guardar() {
        try {
            BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter(new File("registro.csv")));

            bufferedWriter.write("Jugador" + "," + "Ganadas" + "," + "Perdidas");
            bufferedWriter.newLine();
            bufferedWriter.write("Jugador[X]" + "," + vjugador1 + "," +djugador1);
            bufferedWriter.newLine();
            bufferedWriter.write("Jugador[O]" + "," +vjugador2 + "," +djugador2);
    ...
    public void cargar() {
        try {
            BufferedReader bufferedReader = new BufferedReader(new FileReader("registro.csv"));
            String linea;
            while ((linea = bufferedReader.readLine()) != null){
                String[] campos = linea.split(",");
                if (campos[0].equalsIgnoreCase("Jugador[X]")){
                    vjugador1 = Integer.parseInt(campos[1]);
                    djugador1 = Integer.parseInt(campos[2]);
                } else if (campos[0].equalsIgnoreCase("Jugador[O]")) {
                    vjugador2 = Integer.parseInt(campos[1]);
                    djugador2 = Integer.parseInt(campos[2]);
                }
            }
